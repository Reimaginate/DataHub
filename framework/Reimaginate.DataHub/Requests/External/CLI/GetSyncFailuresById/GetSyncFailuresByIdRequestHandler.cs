...
public class GetSyncFailuresByIdRequestHandler(IMediator mediator, IMapper mapper) : IHandler<GetSyncFailuresByIdRequest, GetSyncFailuresResponse>
{
    public async Task<GetSyncFailuresResponse> HandleAsync(GetSyncFailuresByIdRequest request, CancellationToken cancellationToken)
    {
        var parameters = new List<QueryParameter>
        {
            new("type", nameof(SyncFailure))
        };
