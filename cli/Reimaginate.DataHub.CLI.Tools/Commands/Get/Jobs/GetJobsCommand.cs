...
public class GetJobsCommand : SubCommand<GetCommand>
{
    public GetJobsCommand(IServiceProvider serviceProvider) : base("jobs", serviceProvider)
    {
    ...
    {
        nameof(JobDTO.JobId),
        nameof(JobDTO.CreatedBy),
        nameof(JobDTO.CompletedOn),
        nameof(JobDTO.Request),
